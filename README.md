...
1) We **pooled odds ratio** of ASD among MTHFR C677T or A1298C homozygous individuals compared to control cohorts using a random effect model. (step1_major_analysis.R)
